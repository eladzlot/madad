...
// The trial has no sanitizePid: formatUid replaces it, validating the check
// symbol and canonicalising, so a crafted string never reaches the UI.
...
import './components/item-rated-text.js';
