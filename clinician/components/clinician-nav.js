...
//
// Links are relative: every clinician surface lives one level below the
// site root (/composer/, /aggregate/, /landing/), so `../x/` resolves
  ...
  render() {
    return html`
      <header>
        <div class="inner">
          <div class="nav-group">
            <a class="brand" href="../landing/">מדד</a>
